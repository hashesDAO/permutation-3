...
export interface TestRoyaltyEngineInterface extends utils.Interface {
  functions: {
...
export interface TestRoyaltyEngine extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestRoyaltyEngineInterface;
