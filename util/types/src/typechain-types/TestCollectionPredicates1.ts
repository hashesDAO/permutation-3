...
export interface TestCollectionPredicates1Interface extends utils.Interface {
  functions: {
...
export interface TestCollectionPredicates1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCollectionPredicates1Interface;
