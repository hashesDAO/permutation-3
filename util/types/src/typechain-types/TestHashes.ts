...
export interface TestHashesInterface extends utils.Interface {
  functions: {
...
export interface TestHashes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestHashesInterface;
  ...
  callStatic: {
    ...
    setNonce(_nonce: BigNumberish, overrides?: CallOverrides): Promise<void>;
