...
export interface TestRoyaltyRegistryInterface extends utils.Interface {
  functions: {
...
export interface TestRoyaltyRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestRoyaltyRegistryInterface;
